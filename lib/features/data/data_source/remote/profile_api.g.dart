...
class _ProfileApi implements ProfileApi {
  ...
  @override
  Future<HttpResponse<List<ProfileModel>>> getProfiles(String api) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'x-api-key': api};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<List<ProfileModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
